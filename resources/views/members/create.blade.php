...
@section('title', 'Add Member - ACTS Church CMS')
@section('page-title', 'Add New Member')
@section('page-description', 'Register a new church member')
...
<div class="max-w-4xl">
    <form method="POST" action="{{ route('members.store') }}" enctype="multipart/form-data">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="md:col-span-2">
                    ...
                    <textarea name="address" rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-gold-500 focus:border-gold-500">{{ old('address') }}</textarea>
                </div>
                <div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="membership_class" value="{{ old('membership_class') }}"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-gold-500 focus:border-gold-500">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="family_role" value="{{ old('family_role') }}" placeholder="e.g., Father, Mother, Child"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-gold-500 focus:border-gold-500">
                </div>
                <div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="notes" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-gold-500 focus:border-gold-500">{{ old('notes') }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center justify-end space-x-3">
            <a href="{{ route('members.index') }}" class="px-5 py-2.5 text-sm text-gray-600 hover:text-gray-800 border border-gray-300 rounded-lg">Cancel</a>
